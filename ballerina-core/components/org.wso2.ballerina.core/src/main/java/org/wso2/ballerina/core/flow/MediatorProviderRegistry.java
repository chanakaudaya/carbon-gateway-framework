...
import org.wso2.ballerina.core.flow.mediators.builtin.flowcontrollers.filter.dataparallelmediaor.JoinMediator;
...
public class MediatorProviderRegistry implements ProviderRegistry {
    ...
    private final Class[] builtinMediatorClasses = {
            CallMediator.class, FilterMediator.class, RespondMediator.class, LogMediator.class, EnrichMediator.class,
            TransformMediator.class, PropertyMediator.class, DataParallelMediator.class, JoinMediator.class,
            };
